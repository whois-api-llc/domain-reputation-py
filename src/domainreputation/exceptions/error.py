...
class DomainReputationApiError(Exception):
...
class ParameterError(DomainReputationApiError):
    pass


class EmptyApiKeyError(DomainReputationApiError):
    pass


class ResponseError(DomainReputationApiError):
    def __init__(self, message):
        self.message = message
...
class UnparsableApiResponseError(DomainReputationApiError):
...
class HttpApiError(DomainReputationApiError):
    pass
